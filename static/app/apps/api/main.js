...
const mockPromise = __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.t.bind(null, /*! ./data/products-mock.json */ "./apps/api/src/app/data/products-mock.json", 3)).then(m => m.default);
...
/* harmony import */ var _db_mongo_config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./db-mongo-config */ "./apps/api/src/app/db-mongo-config.ts");
/* harmony import */ var _websockets_ws_controller_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./websockets/ws-controller.service */ "./apps/api/src/app/websockets/ws-controller.service.ts");
...
/***/ "./apps/api/src/app/db-mongo-config.ts":
/*!*********************************************!*\
  !*** ./apps/api/src/app/db-mongo-config.ts ***!
  \*********************************************/
...
/***/ "./apps/api/src/app/websockets/ws-controller.service.ts":
/*!**************************************************************!*\
  !*** ./apps/api/src/app/websockets/ws-controller.service.ts ***!
  \**************************************************************/
...
module.exports = __webpack_require__(/*! /Users/bullwinkle/Projects/Dimaha-workspace/apps/api/src/main.ts */"./apps/api/src/main.ts");
